...
<!-- Mirrored from html.lionode.com/timewatch/Watch Time/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Aug 2018 23:13:50 GMT -->
<head>
      ...
      <div class="nav-inner">
        ...
        <div class="navbar-collapse">
          <ul class="main-navigation">
            ...
            <li><a href="category.html"   class="parent"  >Thương hiệu</a> </li>
            <li><a href="category.html"   class="parent"  >Đồng hồ Nữ</a> </li>
            <li><a href="category.html"   class="parent"  >Đồn hồ Nam</a> </li>
            <li><a href="category.html"   class="parent"  >Phụ kiện</a> </li>
            <li><a href="#" class="active parent">Trang</a>
              <ul>
...
<div class="container">
  <div class="row">  
    <div id="brand_carouse" class="owl-carousel brand-logo">
        <div class="item text-center"> <a href="#"><img src="{{url('public')}}/frontend/image/brand/brand1.png" alt="Disney" class="img-responsive" /></a> </div>
        ...
        <div class="item text-center"> <a href="#"><img src="{{url('public')}}/frontend/image/brand/brand4.png" alt="Canon" class="img-responsive" /></a> </div>
        ...
        <div class="item text-center"> <a href="#"><img src="{{url('public')}}/frontend/image/brand/brand6.png" alt="Canon" class="img-responsive" /></a> </div>
        ...
        <div class="item text-center"> <a href="#"><img src="{{url('public')}}/frontend/image/brand/brand8.png" alt="Canon" class="img-responsive" /></a> </div>
    ...
    <div class="cms_banner ">
      <div class="col-md-4 cms-banner-left"> <a href="#"><img alt="#" src="{{url('public')}}/frontend/image/banners/subbanner1.jpg"></a> </div>
      <div class="col-md-4 cms-banner-middle"><a href="#"> <img alt="#" src="{{url('public')}}/frontend/image/banners/subbanner2.jpg"></a></div>
      <div class="col-md-4 cms-banner-right"> <a href="#"><img alt="#" src="{{url('public')}}/frontend/image/banners/subbanner3.jpg"></a> </div>
    </div>
  </div>
  <div class="row">
        ...
        <div id="tab-bestseller" class="tab-content">
          <div class="box">
            <div id="bestseller-slidertab" class="row owl-carousel product-slider">
              ...
              <div class="item">
                <div class="product-thumb transition">
                  <div class="image product-imageblock"> <a href="product.html"> <img src="{{url('public')}}/frontend/image/product/product8.jpg" alt="lorem ippsum dolor dummy" title="lorem ippsum dolor dummy" class="img-responsive" /> </a>
                    <div class="button-group">
                      <button type="button" class="wishlist" data-toggle="tooltip" title="Add to Wish List" ><i class="fa fa-heart-o"></i></button>
                      <button type="button" class="addtocart-btn" >Add To Cart</button>
                      <button type="button" class="compare" data-toggle="tooltip" title="Compare this Product" ><i class="fa fa-exchange"></i></button>
        ...
        <ul id="testimonial" class="row owl-carousel product-slider">
          <li class="item">
            <div class="panel-default">
              <div class="testimonial-image"><img src="{{url('public')}}/frontend/image/t1.jpg" alt="#"></div>
          ...
          <li class="item">
            <div class="panel-default">
              <div class="testimonial-image"><img src="{{url('public')}}/frontend/image/t2.jpg" alt="#"></div>
          ...
          <li class="item">
            <div class="panel-default">
              <div class="testimonial-image"><img src="{{url('public')}}/frontend/image/t3.jpg" alt="#"></div>
              <div class="testimonial-name"><h2>Janet Wilson</h2></div>
              <div class="testimonial-designation"><p>Web Designer</p></div>
              <div class="testimonial-desc">Rem ipsum doLoremRem ipsum doLorem ipsum ut labore et dolore ma ipsum ut labore et <br> dolore  Rem ipsum doLorem ipsum ut labore et dolore mamagna.Lorem ipsum doLorem ipsum dolor sit amet, consectetur adipisicing.</div>
          ...
          <li class="item">
            <div class="panel-default">
              <div class="testimonial-image"><img src="{{url('public')}}/frontend/image/t4.jpg" alt="#"></div>
              <div class="testimonial-name"><h2>Linda Howard</h2></div>
              <div class="testimonial-designation"><p>Web Deweloper</p></div>
              <div class="testimonial-desc">Rem ipsum doLoremRem ipsum doLorem ipsum ut labore et dolore ma ipsum ut labore et <br> dolore  Rem ipsum doLorem ipsum ut labore et dolore mamagna.Lorem ipsum doLorem ipsum dolor sit amet, consectetur adipisicing.</div>
  ...
  <div class="container">
    ...
    <div class="footer-bottom-cms">
      <div class="footer-payment">
        <ul>
          <li class="mastero"><a href="#"><img alt="" src="{{url('public')}}/frontend/image/payment/mastero.jpg"></a></li>
          <li class="visa"><a href="#"><img alt="" src="{{url('public')}}/frontend/image/payment/visa.jpg"></a></li>
          <li class="currus"><a href="#"><img alt="" src="{{url('public')}}/frontend/image/payment/currus.jpg"></a></li>
          <li class="discover"><a href="#"><img alt="" src="{{url('public')}}/frontend/image/payment/discover.jpg"></a></li>
          <li class="bank"><a href="#"><img alt="" src="{{url('public')}}/frontend/image/payment/bank.jpg"></a></li>
        </ul>
      </div>
    </div>
  </div>
